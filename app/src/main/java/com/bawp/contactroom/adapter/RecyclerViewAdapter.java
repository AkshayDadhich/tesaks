...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.designation.setText(contact.getEmp_designation());
        holder.postedDistrict.setText(contact.getPosted_district());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView postedDistrict;
        ...
        public ViewHolder(@NonNull View itemView, OnContactClickListener onContactClickListener) {
            ...
            designation = itemView.findViewById(R.id.row_designation_textview);
            postedDistrict = itemView.findViewById(R.id.row_posted_district_textview);
