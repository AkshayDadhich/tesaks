...
public class NewContact extends AppCompatActivity {
    ...
    public static final String RESIDENCE = "residenceNo";
    public static final String EMAIL = "email";
    public static final String CUGNO = "cugNo";
    public static final String MOBNO = "mobNo";
    private EditText enterName;
    private EditText enterOccupation;
    private EditText enterPhoneNo;
...
//                    enterPhoneNo.setText(contact.getPhoneNo());
                }
            });
            isEdit = true;
        ...
        saveInfoButton.setOnClickListener(view -> {
            ...
            if (!TextUtils.isEmpty(enterName.getText())
                ...
                replyIntent.putExtra(DESIGNATION, occupation);
                replyIntent.putExtra(OFFICEPHONE, phoneNo);
    ...
    private void edit(Boolean isDelete) {
        ...
        String phoneNo = enterPhoneNo.getText().toString().trim();

        if (TextUtils.isEmpty(name) || TextUtils.isEmpty(occupation)) {
            Snackbar.make(enterName, R.string.enter_information, Snackbar.LENGTH_SHORT)
                    .show();
        } else {
            Contact contact = new Contact();
            contact.setId(contactId);
            contact.setName(name);
//            contact.setDesignation(designaiton);
